...
const Navbar = () => {
  ...
  return ( <nav>
    ...
    <div className={`buttons ${toggle ? "showMenu" : ""}`}>
      <div className="but"><Link to="home" spy={true} smooth={true} offset={-100} duration={500}>HOME</Link></div>
      <div className="but"><Link to="details"spy={true} smooth={true} offset={-120} duration={500}>DETAILS</Link></div>
